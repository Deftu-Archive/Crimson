...
import xyz.qalcyo.crimson.core.gui.components.builders.*
...
class ConfirmationMenu(
    ...
    init {
        var contentColor = CrimsonPalette.getSecondary().asColor()
        ...
        } childOf this effect OutlineEffect(CrimsonPalette.getPrimary().asColor(), 1f)
